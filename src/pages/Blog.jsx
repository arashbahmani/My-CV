...
const blogsData = [
  ...
  },
  {
    img: zanjanImg,
    title: "درباره زنجان",
    text: "زنجان در شمال‌غرب کشور و از مناطق تُرک زبان ایران هست. سوغات‌های مهمش چاقو و ملیله و مس عه. اینجا یه شهر متوسط و متعادل با آب‌وهوای پاک و کمی سرده که من خیلی دوستش دارم.",
  },
];
